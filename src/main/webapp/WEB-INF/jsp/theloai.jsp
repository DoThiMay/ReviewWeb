...
<body>
		...
		<div class="search-bar">
			<form action="/search" method="get" class="form-inline">
				<input type="text" name="query" value="${query}"
					placeholder="Tìm kiếm theo tên tài liệu" class="form-control">
		...
		<div class="nav-left">
			...
			<div class="dropdown">
				...
				<div class="dropdown-content">
					<a href="/theloai/sach_ngonngu"> Sách ngoại ngữ </a> <a
						href="/theloai/sach_tamlykynang"> Sách Tâm lý - Kỹ năng </a> <a
						href="/theloai/sachlichsuvanhoa"> Sách Lịch Sử - Văn Hóa </a>
				</div>
			</div>
			<div class="dropdown">
				<a href="#"> Review Truyện </a>
				<div class="dropdown-content">
					<a href="/theloai/truyen_cotich"> Truyện cổ tích </a> <a
						href="/theloai/truyen_tieuthuyet"> Tiểu thuyết </a> <a
						href="/theloai/truyen_truyenngan"> Truyện ngắn </a>
				</div>
			</div>
		</div>
		<!-- Menu bên phải -->
	...
	<div class="reviews-container">
		...
		<footer>
			&copy; 2024 Góc nhỏ.vn | <a href="#about">About Us</a> | Hotline:
			0999999999
		</footer>
</body>
</html>
